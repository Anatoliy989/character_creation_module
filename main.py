...
def attack(char_name: str, char_class: str) -> str:
    """Согласно имени и класу образует рандомный урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Согласно имени и класу образует рандомный блок."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описание выбираемого класса и подтверждение."""
    approve_choice: str = ''
    char_class: str = ''
...
def main():
    """Знакомство и предложегие выбрать класс."""
